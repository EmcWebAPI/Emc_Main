...
namespace EmcReportWebApi.Controllers
{
    public class ReportController : ApiController
    {
        ...
        private string JsonToWord(string jsonStr)
        {
            ...
            {
                //审查表 //测试数据
                string scbWord = currRoot + "\\Files\\ReportFiles\\Test\\" + (string)mainObj["scbWord"];
        ...
        private string SetConductedEmission(WordUtil wordUtil, JObject jObject, string bookmark, string rtfType, string middleDir)
        {
            ...
            {
                list.Add(GetTestPath(item["name"].ToString()) + "," + item["content"].ToString());
            }
        ...
        /// </summary>
        /// <returns></returns>
        private string SetOtherEmission() {
            return "成功";
        }
        #endregion
