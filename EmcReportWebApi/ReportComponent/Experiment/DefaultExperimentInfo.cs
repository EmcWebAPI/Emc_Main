...
namespace EmcReportWebApi.ReportComponent.Experiment
{
    ...
    /// 默认实验信息
    /// </summary>
    public sealed class DefaultExperimentInfo:ExperimentInfoAbstract
    {
        /// <summary>
        /// new
        /// </summary>
        ...
        public DefaultExperimentInfo(ReportInfo reportInfo, ExperimentInfo experimentInfo, string experimentName, JObject experimentJObject)
        {
            ...
            if (experimentJObject["sysj"] != null)
            {
                ...
                foreach (var item in (JArray)experimentJObject["sysj"])
                {
                    ...
                    this.ExperimentDataInfos.Add(new DefaultExperimentDataInfo(reportInfo, this, experimentDataJObject));
                }
            }
            //实验连接图
