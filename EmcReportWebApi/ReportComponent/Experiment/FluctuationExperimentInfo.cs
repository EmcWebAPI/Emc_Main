...
namespace EmcReportWebApi.ReportComponent.Experiment
{
    ...
    /// 电压波动和闪烁
    /// </summary>
    public sealed class FluctuationExperimentInfo : ExperimentInfoAbstract
    {
        /// <summary>
        /// new
        /// </summary>
        ...
        public FluctuationExperimentInfo(ReportInfo reportInfo, ExperimentInfo experimentInfo, string experimentName, JObject experimentJObject)
        {
            ...
            RtfTableInfo = EmcConfig.RtfTableInfos.FirstOrDefault(p => p.RtfType.Equals("波动"));
            RtfPictureInfo = EmcConfig.RtfPictureInfos.FirstOrDefault(p => p.RtfType.Equals("波动"));
