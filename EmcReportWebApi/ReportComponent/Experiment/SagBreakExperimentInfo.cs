...
namespace EmcReportWebApi.ReportComponent.Experiment
{
    ...
    /// 交直流电源线 电压暂降和短时中断
    /// </summary>
    public sealed class SagBreakExperimentInfo : ExperimentInfoAbstract
    {
        /// <summary>
        /// new
        /// </summary>
        ...
        public SagBreakExperimentInfo(ReportInfo reportInfo, ExperimentInfo experimentInfo, string experimentName, JObject experimentJObject)
        {
