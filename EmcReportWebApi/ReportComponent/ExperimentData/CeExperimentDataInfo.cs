            ...
            foreach (var rtf in ExperimentDataRtfJArray)
            {
                try
                {
                    ...
                    wordUtil.CopyOtherFileTableForColByTableIndex(_experimentInfo.ExperimentDataTemplateFileFullname,
                        ...
                        _experimentInfo.RtfTableInfo.MainTitle, false, true, false);

                    wordUtil.CopyOtherFilePictureToWord(_experimentInfo.ExperimentDataTemplateFileFullname,
                        _reportInfo.ReportFilesPath + "\\" + rtfObj["name"].ToString(),
