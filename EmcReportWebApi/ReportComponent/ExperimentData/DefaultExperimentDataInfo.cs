...
namespace EmcReportWebApi.ReportComponent.ExperimentData
{
    ...
    /// 默认实验数据
    /// </summary>
    public class DefaultExperimentDataInfo:ExperimentDataInfoAbstract
    {
        ...
        public DefaultExperimentDataInfo(ReportInfo reportInfo, ExperimentInfoAbstract experimentInfo, JObject experimentDataJObject)
        {
